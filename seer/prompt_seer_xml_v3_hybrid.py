"""Seer XML prompt v3 hybrid: v2b's stricter instructions + v1's few-shot examples.

Combines the best of both worlds:
- v2b's balanced anti-shortcut evaluation rules (reduce false positives)
- v1's 6 few-shot examples (anchor pairwise ordering calibration)
"""
